...
KAL_FALSE,KAL_FALSE,KAL_FALSE,176800000,176800000,176800000,0,0,0,64,64,64,IMX179MIPI_PV_LINE_LENGTH_PIXELS,IMX179MIPI_PV_FRAME_LENGTH_LINES,
...
kal_uint8  IMX179test_pattern_flag=0;
#define IMX179_2LANE_TEST_PATTERN_CHECKSUM (0x9e08861c)
...
void IMX179MIPI_write_shutter(kal_uint16 shutter)
{
    ...
    if (IMX179MIPI_sensor.pv_mode == KAL_TRUE) 
	 {
	   max_exp_shutter = IMX179MIPI_PV_FRAME_LENGTH_LINES + IMX179MIPI_sensor.pv_dummy_lines-4;
     }
     else if (IMX179MIPI_sensor.video_mode== KAL_TRUE) 
     {
       max_exp_shutter = IMX179MIPI_VIDEO_FRAME_LENGTH_LINES + IMX179MIPI_sensor.video_dummy_lines-4;
	 }	 
     else if (IMX179MIPI_sensor.capture_mode== KAL_TRUE) 
     {
       max_exp_shutter = IMX179MIPI_FULL_FRAME_LENGTH_LINES + IMX179MIPI_sensor.cp_dummy_lines-4;
	 }	 
	 else
	 	{
...
static void IMX179MIPI_Sensor_Init(void)
{
	...
	IMX179MIPI_write_cmos_sensor(0x3344, 0x6F); 		 
	IMX179MIPI_write_cmos_sensor(0x3345, 0x1F); 		 
	IMX179MIPI_write_cmos_sensor(0x3362, 0x0A); 		 
	IMX179MIPI_write_cmos_sensor(0x3363, 0x0A); 		 
	IMX179MIPI_write_cmos_sensor(0x3364, 0x02); 		
	IMX179MIPI_write_cmos_sensor(0x3368, 0x18); 		 
	IMX179MIPI_write_cmos_sensor(0x3369, 0x00); 		 
	IMX179MIPI_write_cmos_sensor(0x3370, 0x7F); 		 
	IMX179MIPI_write_cmos_sensor(0x3371, 0x37); 		 
	IMX179MIPI_write_cmos_sensor(0x3372, 0x67); 		 
	IMX179MIPI_write_cmos_sensor(0x3373, 0x3F); 		 
	IMX179MIPI_write_cmos_sensor(0x3374, 0x3F); 		 
	IMX179MIPI_write_cmos_sensor(0x3375, 0x47); 		 
	IMX179MIPI_write_cmos_sensor(0x3376, 0xCF); 		 
	IMX179MIPI_write_cmos_sensor(0x3377, 0x47); 		
...
{	//77 capture setting
	...
	IMX179MIPI_write_cmos_sensor(0x0101, 0x03); 		
	IMX179MIPI_write_cmos_sensor(0x030E, 0x0C); 		 
	IMX179MIPI_write_cmos_sensor(0x0202, 0x06);
	IMX179MIPI_write_cmos_sensor(0x0203, 0x8A);
	//PLLsetting
	IMX179MIPI_write_cmos_sensor(0x0301, 0x0A); 		 
	IMX179MIPI_write_cmos_sensor(0x0303, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x0305, 0x06); 		 
	...
	IMX179MIPI_write_cmos_sensor(0x0340, 0x06);
	IMX179MIPI_write_cmos_sensor(0x0341, 0x8E); 		 
	IMX179MIPI_write_cmos_sensor(0x0342, 0x0D); 		 
	IMX179MIPI_write_cmos_sensor(0x0343, 0x70); 		 
	IMX179MIPI_write_cmos_sensor(0x0344, 0x00); 		 
	IMX179MIPI_write_cmos_sensor(0x0345, 0x00); 		 
	IMX179MIPI_write_cmos_sensor(0x0346, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x0347, 0x90); 		 
	IMX179MIPI_write_cmos_sensor(0x0348, 0x0C); 		 
	IMX179MIPI_write_cmos_sensor(0x0349, 0xCF); 		 
	IMX179MIPI_write_cmos_sensor(0x034A, 0x08); 		 
	IMX179MIPI_write_cmos_sensor(0x034B, 0x0F); 		 
	IMX179MIPI_write_cmos_sensor(0x034C, 0x0C); 		 
	IMX179MIPI_write_cmos_sensor(0x034D, 0xD0); 		 
	IMX179MIPI_write_cmos_sensor(0x034E, 0x06); 		
	IMX179MIPI_write_cmos_sensor(0x034F, 0x80); 		 
	IMX179MIPI_write_cmos_sensor(0x0383, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x0387, 0x01); 		 
	...
	IMX179MIPI_write_cmos_sensor(0x33D6, 0x06); 		 
	IMX179MIPI_write_cmos_sensor(0x33D7, 0x80); 		 
	IMX179MIPI_write_cmos_sensor(0x4100, 0x0E); 		 
	IMX179MIPI_write_cmos_sensor(0x4108, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x4109, 0x7C);  
	IMX179MIPI_write_cmos_sensor(0x0100, 0x01);//STREAM ON
...
{	//77 capture setting
	...
	IMX179MIPI_write_cmos_sensor(0x0203, 0xAA);
	//PLLsetting
	IMX179MIPI_write_cmos_sensor(0x0301, 0x0A);          
	IMX179MIPI_write_cmos_sensor(0x0303, 0x01);          
	IMX179MIPI_write_cmos_sensor(0x0305, 0x06);          
	...
	IMX179MIPI_write_cmos_sensor(0x0341, 0xAE);          
	IMX179MIPI_write_cmos_sensor(0x0342, 0x0D);          
	IMX179MIPI_write_cmos_sensor(0x0343, 0x70);          
	IMX179MIPI_write_cmos_sensor(0x0344, 0x00);          
	IMX179MIPI_write_cmos_sensor(0x0345, 0x00);          
	...
	IMX179MIPI_write_cmos_sensor(0x034F, 0xA0);          
	IMX179MIPI_write_cmos_sensor(0x0383, 0x01);          
	IMX179MIPI_write_cmos_sensor(0x0387, 0x01);          
	IMX179MIPI_write_cmos_sensor(0x0390, 0x00);          
	IMX179MIPI_write_cmos_sensor(0x0401, 0x00);          
...
void IMX179MIPI_SetShutter(kal_uint16 iShutter)
{
   ...
   SENSORDB("shutter&gain test by hhl: set shutter IMX179MIPI_SetShutter\n"); 
    if (iShutter < 1)
        iShutter = 1; 
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if (IMX179MIPI_sensor.pv_mode == KAL_TRUE||IMX179MIPI_sensor.video_mode == KAL_TRUE)
	{
		spin_lock(&imx179_drv_lock);	
		IMX179MIPI_sensor.video_mode=KAL_FALSE;
		IMX179MIPI_sensor.pv_mode=KAL_FALSE;
		...
		spin_unlock(&imx179_drv_lock);
		/* USE IN FACTORY MODE  */
		if(IMX179test_pattern_flag)
		{
			IMX179MIPISetTestPatternMode(TRUE);
			IMX179test_pattern_flag=FALSE;
		}
...
{ 
    ...
    pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_RAW_B;//R
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
        		switch(CurrentScenarioId)
        		{
        			case MSDK_SCENARIO_ID_CAMERA_ZSD:
        			case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
		            *pFeatureReturnPara32 = IMX179MIPI_sensor.cp_pclk; //134400000
		            *pFeatureParaLen=4;		         	
					
		            SENSORDB("Sensor CPCLK:%dn",IMX179MIPI_sensor.cp_pclk); 
		         		break; //hhl 2-28
					case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
						*pFeatureReturnPara32 = IMX179MIPI_sensor.video_pclk;//57600000; //199200000;
						*pFeatureParaLen=4;
						SENSORDB("Sensor videoCLK:%d\n",IMX179MIPI_sensor.video_pclk); 
						break;
		         		default:
		            *pFeatureReturnPara32 = IMX179MIPI_sensor.pv_pclk;//57600000; //199200000;
		            *pFeatureParaLen=4;
		...
		case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
			...
			*pFeatureReturnPara32 = IMX179_2LANE_TEST_PATTERN_CHECKSUM;
			*pFeatureParaLen=4;
			break;
        default:
            break;
...
UINT32 IMX179_MIPI_RAW_2lane_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
