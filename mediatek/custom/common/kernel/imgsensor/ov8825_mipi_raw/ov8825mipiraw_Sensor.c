...
static void OV8825_Sensor_Init(void)
{
	...
	OV8825_write_cmos_sensor(0x5781,0x13);// neil add for white pixels issue
	OV8825_write_cmos_sensor(0x5782,0x03);//
	OV8825_write_cmos_sensor(0x5783,0x02);//
	OV8825_write_cmos_sensor(0x5784,0x01);//	
	OV8825_write_cmos_sensor(0x5786,0x20);//
	OV8825_write_cmos_sensor(0x5788,0x08);//
	OV8825_write_cmos_sensor(0x5789,0x08);//
	OV8825_write_cmos_sensor(0x578a,0x02);//
	OV8825_write_cmos_sensor(0x578b,0x01);//
	OV8825_write_cmos_sensor(0x578c,0x01);//	
	OV8825_write_cmos_sensor(0x578d,0x0c);//
	OV8825_write_cmos_sensor(0x578e,0x02);//
	OV8825_write_cmos_sensor(0x578f,0x01);//
	OV8825_write_cmos_sensor(0x5790,0x01);//							
...
UINT32 OV8825Open(void)
{
	...
	if(1 == ModuleID){
		printk("sym  OV8825SYXOpen SensorMode==1 which is  sanyingxing module\n");
...
UINT32 OV8825GetSensorID(UINT32 *sensorID)
{
	...
	printk("OV8825GetSensorID enter :\n ");
	OV8825_write_cmos_sensor(0x0103,0x01);// Reset sensor
    mDELAY(10);
