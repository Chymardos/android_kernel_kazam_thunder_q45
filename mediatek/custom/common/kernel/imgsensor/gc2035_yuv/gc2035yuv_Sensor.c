...

{
    ...
    // check if sensor ID correct
    	SENSORDB("GC2035_GetSensorID enter\n");  
    do {
    ...
    if (*sensorID != GC2035_SENSOR_ID) {
        *sensorID = 0xFFFFFFFF; 
		    	SENSORDB("GC2035_GetSensorID failed");  
        return ERROR_SENSOR_CONNECT_FAIL;
    }
	    	SENSORDB("GC2035_GetSensorID exit\n");  
    return ERROR_NONE;    
}   /* GC2035Open  */
...
static void GC2035_Sensor_Init(void)
{
	...
	#if defined(_LSC_P_)
	GC2035_write_cmos_sensor(0x84 , 0x02); //output put foramat 
	#else
	GC2035_write_cmos_sensor(0x84 , 0x03); 
	#endif
	...
	GC2035_write_cmos_sensor(0xfe, 0x01);
	GC2035_write_cmos_sensor(0xc2, 0x27);
	GC2035_write_cmos_sensor(0xc3, 0x1d);
	GC2035_write_cmos_sensor(0xc4, 0x1a);
	GC2035_write_cmos_sensor(0xc8, 0x26);
	GC2035_write_cmos_sensor(0xc9, 0x25);
	GC2035_write_cmos_sensor(0xca, 0x16);
	GC2035_write_cmos_sensor(0xbc, 0x47);
	GC2035_write_cmos_sensor(0xbd, 0x36);
	GC2035_write_cmos_sensor(0xbe, 0x25);
	GC2035_write_cmos_sensor(0xb6, 0x46);
	GC2035_write_cmos_sensor(0xb7, 0x35);
	GC2035_write_cmos_sensor(0xb8, 0x2a);
	...
	GC2035_write_cmos_sensor(0xb9, 0x0d);
	GC2035_write_cmos_sensor(0xba, 0x0e);
	GC2035_write_cmos_sensor(0xbb, 0x0e);
	GC2035_write_cmos_sensor(0xaa, 0x07);
	GC2035_write_cmos_sensor(0xab, 0x05);
	GC2035_write_cmos_sensor(0xac, 0x06);
	GC2035_write_cmos_sensor(0xad, 0x00);
	GC2035_write_cmos_sensor(0xae, 0x02);
	GC2035_write_cmos_sensor(0xaf, 0x0a);
	GC2035_write_cmos_sensor(0xb0, 0x10);
	GC2035_write_cmos_sensor(0xb1, 0x0d);
	GC2035_write_cmos_sensor(0xb2, 0x0c);
	GC2035_write_cmos_sensor(0xb3, 0x1c);
	GC2035_write_cmos_sensor(0xb4, 0x1a);
	GC2035_write_cmos_sensor(0xb5, 0x1a);
	GC2035_write_cmos_sensor(0xd0, 0x32);//22
	GC2035_write_cmos_sensor(0xd2, 0x54);//16
	GC2035_write_cmos_sensor(0xd3, 0x43);//22
	GC2035_write_cmos_sensor(0xd8, 0x22);//-1  + 8
	GC2035_write_cmos_sensor(0xda, 0x34);//-1  +20
	GC2035_write_cmos_sensor(0xdb, 0x32);//-4  +16
	GC2035_write_cmos_sensor(0xdc, 0x26);//25
	GC2035_write_cmos_sensor(0xde, 0x21);//14
	GC2035_write_cmos_sensor(0xdf, 0x3f);//23
	GC2035_write_cmos_sensor(0xd4, 0x20);//45
	GC2035_write_cmos_sensor(0xd6, 0x2e);//3b
	GC2035_write_cmos_sensor(0xd7, 0x42);//53
...
///////////////////////////////////////////////                             
GC2035_write_cmos_sensor(0xfe ,0x01);                                       
GC2035_write_cmos_sensor(0xa1 ,0x83); // center_row                         
GC2035_write_cmos_sensor(0xa2 ,0x85); // center_col                         
GC2035_write_cmos_sensor(0xa4 ,0x76); // sign of b1                         
GC2035_write_cmos_sensor(0xa5 ,0x77); // sign of b1                         
GC2035_write_cmos_sensor(0xa6 ,0x67); // sign of b4                         
GC2035_write_cmos_sensor(0xa7 ,0x76); // sign of b4                         
GC2035_write_cmos_sensor(0xa8 ,0x36); // sign of b22                        
GC2035_write_cmos_sensor(0xa9 ,0x10); // sign of b22                        
GC2035_write_cmos_sensor(0xaa ,0x18); // Q1_b1 of R                         
GC2035_write_cmos_sensor(0xab ,0x02); // Q1_b1 of G                         
GC2035_write_cmos_sensor(0xac ,0x04); // Q1_b1 of B                         
GC2035_write_cmos_sensor(0xad ,0x13); // Q2_b1 of R                         
GC2035_write_cmos_sensor(0xae ,0x19); // Q2_b1 of G                         
GC2035_write_cmos_sensor(0xaf ,0x02); // Q2_b1 of B                         
GC2035_write_cmos_sensor(0xb0 ,0x02); // Q3_b1 of R                         
GC2035_write_cmos_sensor(0xb1 ,0x13); // Q3_b1 of G                         
GC2035_write_cmos_sensor(0xb2 ,0x0a); // Q3_b1 of B                         
GC2035_write_cmos_sensor(0xb3 ,0x0c); // Q4_b1 of R                         
GC2035_write_cmos_sensor(0xb4 ,0x00); // Q4_b1 of G                         
GC2035_write_cmos_sensor(0xb5 ,0x03); // Q4_b1 of B                         
GC2035_write_cmos_sensor(0xb6 ,0x58); // right_b2 of R                      
GC2035_write_cmos_sensor(0xb7 ,0x5a); // right_b2 of G                      
GC2035_write_cmos_sensor(0xb8 ,0x21); // right_b2 of B                      
GC2035_write_cmos_sensor(0xb9 ,0x0d); // right_b4 of R                      
GC2035_write_cmos_sensor(0xba ,0x1f); // right_b4 of G                      
GC2035_write_cmos_sensor(0xbb ,0x11); // right_b4 of B                      
GC2035_write_cmos_sensor(0xbc ,0x7e); // left_b2 of R                       
GC2035_write_cmos_sensor(0xbd ,0x46); // left_b2 of G                       
GC2035_write_cmos_sensor(0xbe ,0x3d); // left_b2 of B                       
GC2035_write_cmos_sensor(0xbf ,0x26); // left_b4 of R                       
GC2035_write_cmos_sensor(0xc0 ,0x0b); // left_b4 of G                       
GC2035_write_cmos_sensor(0xc1 ,0x11); // left_b4 of B                       
GC2035_write_cmos_sensor(0xc2 ,0x40); // up_b2 of R                         
GC2035_write_cmos_sensor(0xc3 ,0x30); // up_b2 of G                         
GC2035_write_cmos_sensor(0xc4 ,0x1c); // up_b2 of B                         
GC2035_write_cmos_sensor(0xc5 ,0x2a); // up_b4 of R                         
GC2035_write_cmos_sensor(0xc6 ,0x19); // up_b4 of G                         
GC2035_write_cmos_sensor(0xc7 ,0x0b); // up_b4 of B                         
GC2035_write_cmos_sensor(0xc8 ,0x43); // down_b2 of R                       
GC2035_write_cmos_sensor(0xc9 ,0x2d); // down_b2 of G                       
GC2035_write_cmos_sensor(0xca ,0x18); // down_b2 of B                       
GC2035_write_cmos_sensor(0xcb ,0x20); // down_b4 of R                       
GC2035_write_cmos_sensor(0xcc ,0x0e); // down_b4 of G                       
GC2035_write_cmos_sensor(0xcd ,0x09); // down_b4 of B                       
GC2035_write_cmos_sensor(0xd0 ,0x0b); // right_up_b22 of R                  
GC2035_write_cmos_sensor(0xd2 ,0x30); // right_up_b22 of G                  
GC2035_write_cmos_sensor(0xd3 ,0x00); // right_up_b22 of B                  
GC2035_write_cmos_sensor(0xd4 ,0x00); // right_down_b22 of R                
GC2035_write_cmos_sensor(0xd6 ,0x1c); // right_down_b22 of G                
GC2035_write_cmos_sensor(0xd7 ,0x18); // right_down_b22 of B                
GC2035_write_cmos_sensor(0xd8 ,0x01); // left_up_b22 of R                   
GC2035_write_cmos_sensor(0xda ,0x2c); // left_up_b22 of G                   
GC2035_write_cmos_sensor(0xdb ,0x03); // left_up_b22 of B                   
GC2035_write_cmos_sensor(0xdc ,0x1d); // left_down_b22 of R                 
GC2035_write_cmos_sensor(0xde ,0x49); // left_down_b22 of G                 
GC2035_write_cmos_sensor(0xdf ,0x46); // left_down_b22 of B                 
GC2035_write_cmos_sensor(0xfe ,0x00);                                       
	...
	GC2035_write_cmos_sensor(0x4e , 0x04);																																	  //20           
	GC2035_write_cmos_sensor(0x4d , 0x62);																																	          
	GC2035_write_cmos_sensor(0x4e , 0x10);																																	//00  
	GC2035_write_cmos_sensor(0x4d , 0x72);																																	  //00
	...
	GC2035_write_cmos_sensor(0x56, 0x02);//00  
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x34);//saturation_cb  
	GC2035_write_cmos_sensor(0xd2 , 0x34);//saturation_Cr	
	GC2035_write_cmos_sensor(0xd3 , 0x44);//contrast      peter  40
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x1f);//dn_b_base      peter  15
	GC2035_write_cmos_sensor(0x8c , 0xf6); //[2]b_in_dark_inc
	GC2035_write_cmos_sensor(0x89 , 0x01); //dn_c_weight   peter  03
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x90 , 0x6c);// EEINTP mode1
	GC2035_write_cmos_sensor(0x97 , 0x45);// edge effect   peter  47
	////==============RGB Gamma 
	GC2035_write_cmos_sensor(0xfe , 0x02);
	...
	//add banding 0904 
 	GC2035_write_cmos_sensor(0x05 , 0x01);//hb
 	GC2035_write_cmos_sensor(0x06 , 0x21);
 	GC2035_write_cmos_sensor(0x07 , 0x00);//vb
 	GC2035_write_cmos_sensor(0x08 , 0x5e);
 	GC2035_SET_PAGE1;
 	GC2035_write_cmos_sensor(0x27 , 0x00);//step
 	...
 	GC2035_write_cmos_sensor(0x2b , 0x05);//level2
 	GC2035_write_cmos_sensor(0x2c , 0x1e);
 	GC2035_write_cmos_sensor(0x2d , 0x05);//6e8//level3  6e0
 	GC2035_write_cmos_sensor(0x2e , 0x1e);
 	GC2035_write_cmos_sensor(0x2f , 0x08);//level4
 	GC2035_write_cmos_sensor(0x30 , 0x30);
	GC2035_SET_PAGE0;
	////output DVP/////
	msleep(100);
	GC2035_write_cmos_sensor(0xfe , 0x00);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    	...
    	if(GC2035_sensor_cap_state == KAL_FALSE)
	  {
		...
		#if defined(_LSC_P_)
		image_window->GrabStartX=17;  //1  
		image_window->GrabStartY=13;  //1
		image_window->ExposureWindowWidth=GC2035_IMAGE_SENSOR_FULL_WIDTH - image_window->GrabStartX - 66; //1598  
		image_window->ExposureWindowHeight=GC2035_IMAGE_SENSOR_FULL_HEIGHT -image_window->GrabStartY - 50; //1198   
		#else   //1598x1198 
...
{
	#if defined(_LSC_P_)
	pSensorResolution->SensorFullWidth=GC2035_IMAGE_SENSOR_FULL_WIDTH    - 66; //1534x1150
	pSensorResolution->SensorFullHeight=GC2035_IMAGE_SENSOR_FULL_HEIGHT  - 50;
	pSensorResolution->SensorPreviewWidth=GC2035_IMAGE_SENSOR_PV_WIDTH   - 32; //768 x 576
	pSensorResolution->SensorPreviewHeight=GC2035_IMAGE_SENSOR_PV_HEIGHT - 24;
	pSensorResolution->SensorVideoWidth=GC2035_IMAGE_SENSOR_PV_WIDTH     - 32;
	pSensorResolution->SensorVideoHeight=GC2035_IMAGE_SENSOR_PV_HEIGHT   - 24;	
	#else
	pSensorResolution->SensorFullWidth=GC2035_IMAGE_SENSOR_FULL_WIDTH - 2 * IMAGE_SENSOR_START_GRAB_X;   //1600 -2x2   capture
	pSensorResolution->SensorFullHeight=GC2035_IMAGE_SENSOR_FULL_HEIGHT - 2 * IMAGE_SENSOR_START_GRAB_Y; //1200 -2x2   capture
	pSensorResolution->SensorPreviewWidth=GC2035_IMAGE_SENSOR_PV_WIDTH - 2 * IMAGE_SENSOR_START_GRAB_X;  //preview 800-2x2
	pSensorResolution->SensorPreviewHeight=GC2035_IMAGE_SENSOR_PV_HEIGHT - 2 * IMAGE_SENSOR_START_GRAB_Y;//preview 600-2x2
	pSensorResolution->SensorVideoWidth=GC2035_IMAGE_SENSOR_PV_WIDTH - 2 * IMAGE_SENSOR_START_GRAB_X;    //video   800-2x2  
	pSensorResolution->SensorVideoHeight=GC2035_IMAGE_SENSOR_PV_HEIGHT - 2 * IMAGE_SENSOR_START_GRAB_Y;  //video   600-2x2
	#endif
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	switch (ScenarioId)
	{
		...
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			...
			#if defined(_LSC_P_)
			pSensorInfo->SensorGrabStartX = 8; 
                        pSensorInfo->SensorGrabStartY = 6;
			#else
		...
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
			...
			pSensorInfo->SensorDataLatchCount= 2;
		        #if defined(_LSC_P_)
			pSensorInfo->SensorGrabStartX = 16; 
                        pSensorInfo->SensorGrabStartY = 12;
			#else
                        pSensorInfo->SensorGrabStartX = 2; 
                        pSensorInfo->SensorGrabStartY = 2;	
                        #endif		
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    ...
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x05,0x01);//hb
		GC2035_write_cmos_sensor(0x06,0x04);
		GC2035_write_cmos_sensor(0x07,0x00);//vb
		GC2035_write_cmos_sensor(0x08,0x10);
		GC2035_SET_PAGE1;
		GC2035_write_cmos_sensor(0x27,0x00);//step
		...
		GC2035_write_cmos_sensor(0x2b,0x05);//level2
		GC2035_write_cmos_sensor(0x2c,0x40);
		GC2035_write_cmos_sensor(0x2d,0x05);//6e8//level3  6e0
		GC2035_write_cmos_sensor(0x2e,0x40);
		GC2035_write_cmos_sensor(0x2f,0x08);//level4
		GC2035_write_cmos_sensor(0x30,0x50);
		GC2035_SET_PAGE0;
            break;
...
case AE_EV_COMP_00:
GC2035_SET_PAGE1;
GC2035_write_cmos_sensor(0x13,0x78);//88
GC2035_SET_PAGE0;
break;
/* case AE_EV_COMP_03:
GC2035_SET_PAGE1;
...
return FALSE;
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x78);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
