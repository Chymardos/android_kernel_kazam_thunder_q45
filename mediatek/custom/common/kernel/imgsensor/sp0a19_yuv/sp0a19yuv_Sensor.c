...
#define SP0A19_P0_0xed  0x9c//indoor ae upper bound
#define SP0A19_P0_0xf7  0x88 //indoor ae target//0x98 fs
#define SP0A19_P0_0xf8  0x80//0x90 fs
#define SP0A19_P0_0xec  0x8c//indoor ae low bound

#define SP0A19_P0_0xef  0x74//out door
#define SP0A19_P0_0xf9  0x70
#define SP0A19_P0_0xfa  0x68
#define SP0A19_P0_0xee  0x64

#define SP0A19_P0_0xdd 0x88//0x7c//0x80//0x70
#define SP0A19_P0_0xde 0xa0//0xb0//0xb8//0xb0
 ...
 u8 SP2518_Initialize_from_T_Flash()
{
	...
	for (j=0; j<i; j++)
	{
		...
		else if (SP2518_Init_Reg[j].op_code == SP2518_OP_CODE_REG)
		{
			...
			SP0A19_write_cmos_sensor(SP2518_Init_Reg[j].init_reg, SP2518_Init_Reg[j].init_val);
		}
		else
		{
			printk("REG ERROR!\n");
	   ...
	   if(SP0A19_MPEG4_encode_mode == KAL_TRUE)
		{
				if(sp0a19_isBanding== 0)
				{
					...
					SP0A19_write_cmos_sensor(0xfd,0x00);
                            #else
                            // 26M 1分频 50Hz 12.1569-8fps night preview
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x01);//0x00
					SP0A19_write_cmos_sensor(0x04,0x74);//0xba
					SP0A19_write_cmos_sensor(0x06,0x00);
					SP0A19_write_cmos_sensor(0x09,0x04);
					SP0A19_write_cmos_sensor(0x0a,0xdf);
					SP0A19_write_cmos_sensor(0xf0,0x3e);
					SP0A19_write_cmos_sensor(0xf1,0x00);
					SP0A19_write_cmos_sensor(0xfd,0x01);
					SP0A19_write_cmos_sensor(0x90,0x0c);
					SP0A19_write_cmos_sensor(0x92,0x01);
					SP0A19_write_cmos_sensor(0x98,0x3e);
					SP0A19_write_cmos_sensor(0x99,0x00);
					SP0A19_write_cmos_sensor(0x9a,0x01);
					SP0A19_write_cmos_sensor(0x9b,0x00);
					SP0A19_write_cmos_sensor(0xfd,0x01);
					SP0A19_write_cmos_sensor(0xce,0xe8);
					SP0A19_write_cmos_sensor(0xcf,0x02);
					SP0A19_write_cmos_sensor(0xd0,0xe8);
				...
				else if(sp0a19_isBanding == 1)
				{
					...
					SP0A19_write_cmos_sensor(0xfd,0x00);
                                #else
                                // 26M 1分频 60Hz 12.1569-8fps night preview
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x01);//0x00
					SP0A19_write_cmos_sensor(0x04,0x32);//0x99
					SP0A19_write_cmos_sensor(0x06,0x00);
					SP0A19_write_cmos_sensor(0x09,0x04);
					SP0A19_write_cmos_sensor(0x0a,0xfa);
					...
					SP0A19_write_cmos_sensor(0x9b,0x00);
					SP0A19_write_cmos_sensor(0xfd,0x01);
					SP0A19_write_cmos_sensor(0xce,0xfd);
					SP0A19_write_cmos_sensor(0xcf,0x02);
					SP0A19_write_cmos_sensor(0xd0,0xfd);
					SP0A19_write_cmos_sensor(0xd1,0x02);
					SP0A19_write_cmos_sensor(0xfd,0x00);
                                #endif
				}
	...
	else    // daylight mode
	{
	         ...
	         if(SP0A19_MPEG4_encode_mode == KAL_TRUE)
	          {
				...
				else if(sp0a19_isBanding == 1)
				{
					...
					SP0A19_write_cmos_sensor(0xfd,0x00);
                                #else 
                                // 26M 1分频 60Hz 12.1569-8fps daylight preview
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x01);//0x00
					SP0A19_write_cmos_sensor(0x04,0x32);//0x99
					SP0A19_write_cmos_sensor(0x06,0x00);
			...
			else 
			{
				if(sp0a19_isBanding== 0)
				{
					...
					SP0A19_write_cmos_sensor(0xfd,0x00);
				#else
				// 26M 1分频 50Hz 12.1569-8fps daylight preview
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x00);
					SP0A19_write_cmos_sensor(0x04,0xba);
					SP0A19_write_cmos_sensor(0x06,0x00);
					SP0A19_write_cmos_sensor(0x09,0x04);
					SP0A19_write_cmos_sensor(0x0a,0xdf);
					SP0A19_write_cmos_sensor(0xf0,0x3e);
...
#if 1//update by sp_cm1105
SP0A19_write_cmos_sensor(0xfd,0x00);
SP0A19_write_cmos_sensor(0x1c,0x3c);
...
SP0A19_write_cmos_sensor(0xf4,0x08);//0x09
...
SP0A19_write_cmos_sensor(0xe7,0x0e);
SP0A19_write_cmos_sensor(0xd5,0x0e);
SP0A19_write_cmos_sensor(0xd9,0x0e);
SP0A19_write_cmos_sensor(0xd2,0x15);
SP0A19_write_cmos_sensor(0xd6,0x15);
SP0A19_write_cmos_sensor(0xda,0x15);
SP0A19_write_cmos_sensor(0xe8,0x24);//0x24
SP0A19_write_cmos_sensor(0xec,0x2c);//0x2c
SP0A19_write_cmos_sensor(0xe9,0x20);
SP0A19_write_cmos_sensor(0xed,0x28);//0x28
SP0A19_write_cmos_sensor(0xea,0x18);//0x18 fs
SP0A19_write_cmos_sensor(0xef,0x20);
SP0A19_write_cmos_sensor(0xeb,0x10);
SP0A19_write_cmos_sensor(0xf0,0x15);
SP0A19_write_cmos_sensor(0xfd,0x01);
SP0A19_write_cmos_sensor(0xa0,0x6a);    
SP0A19_write_cmos_sensor(0xa1,0x00);    
SP0A19_write_cmos_sensor(0xa2,0x15);    
...
SP0A19_write_cmos_sensor(0x8c,0x0c);
...
SP0A19_write_cmos_sensor(0xfd,0x00);
SP0A19_write_cmos_sensor(0xed,SP0A19_P0_0xed);
SP0A19_write_cmos_sensor(0xf7,SP0A19_P0_0xf7);
SP0A19_write_cmos_sensor(0xf8,SP0A19_P0_0xf8);
SP0A19_write_cmos_sensor(0xec,SP0A19_P0_0xec);
SP0A19_write_cmos_sensor(0xef,SP0A19_P0_0xef);
SP0A19_write_cmos_sensor(0xf9,SP0A19_P0_0xf9);
SP0A19_write_cmos_sensor(0xfa,SP0A19_P0_0xfa);
SP0A19_write_cmos_sensor(0xee,SP0A19_P0_0xee);
SP0A19_write_cmos_sensor(0xfd,0x01);
...
SP0A19_write_cmos_sensor(0xb3,0x1f);
SP0A19_write_cmos_sensor(0xb4,0x60);
SP0A19_write_cmos_sensor(0xb5,0x75);
SP0A19_write_cmos_sensor(0xfd,0x00);
...
SP0A19_write_cmos_sensor(0xd3,0x80);//0x84
SP0A19_write_cmos_sensor(0xd4,0x80);
SP0A19_write_cmos_sensor(0xd6,0x70);//0x74
SP0A19_write_cmos_sensor(0xd7,0x60);
SP0A19_write_cmos_sensor(0xfd,0x00);
SP0A19_write_cmos_sensor(0xdc,0x00);
SP0A19_write_cmos_sensor(0xdd,SP0A19_P0_0xdd);
SP0A19_write_cmos_sensor(0xde,SP0A19_P0_0xde);
...
SP0A19_write_cmos_sensor(0x5f,0x51);
	  ...
	  SP0A19_write_cmos_sensor(0x31,0x10);//0x10  df 00 
	...
	//sharpen 
	  ...
	  SP0A19_write_cmos_sensor(0xe6,0x08); //rangek_neg_normal	 // 0x08 //df 04
	  SP0A19_write_cmos_sensor(0xd4,0x08); //rangek_pos_normal	 // 0x08 //df 04
	  SP0A19_write_cmos_sensor(0xd8,0x08); //range_base_normal	 // 0x08 //df 04
	...
	//saturation
	  ...
	  SP0A19_write_cmos_sensor(0xc0,0xff); 
	  SP0A19_write_cmos_sensor(0xc1,0xd8); 
	  SP0A19_write_cmos_sensor(0xd3,0xa8); //0x78  //df 88 
	  SP0A19_write_cmos_sensor(0xd4,0xa8); //0x78 //df 88
	  SP0A19_write_cmos_sensor(0xd6,0x90); //0x78	   (0xd7,0x60); //0x78  //df 70
	  SP0A19_write_cmos_sensor(0xd7,0x80);  //df 60

	//HEQ
	  SP0A19_write_cmos_sensor(0xfd,0x00); 
	  SP0A19_write_cmos_sensor(0xdc,0x00); 
	  SP0A19_write_cmos_sensor(0xdd,0x85); //0x80 0813	// 0x78   //df 80 
	  SP0A19_write_cmos_sensor(0xde,0x98); //80  0x88  0813  //df  a8
	  SP0A19_write_cmos_sensor(0xdf,0x80); 
...
UINT32 SP0A19Open(void)
{
    ...
    mdelay(10);
	 ...
	 struct file *fp; 
		...
		if (IS_ERR(fp)) { 
			fromsd = 0;   
			SENSORDB("open file error\n");
			
		} 
		else 
			{
			fromsd = 1;
		SENSORDB("open file ok\n");
...
BOOL SP0A19_set_param_effect(UINT16 para)
{
	...
	switch (para)
	{
		...
		case MEFFECT_SEPIA:
			...
			SP0A19_write_cmos_sensor(0x63, 0x94);//0xc0//0x90
			SP0A19_write_cmos_sensor(0x64, 0x68);//0x20
			break;  
...
BOOL SP0A19_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_03: 
			//ae target
			  SP0A19_write_cmos_sensor(0xfd,0x00); 
			  SP0A19_write_cmos_sensor(0xed,SP0A19_P0_0xed+0x18); //indoor ae upper bound
			  SP0A19_write_cmos_sensor(0xf7,SP0A19_P0_0xf7+0x18); //indoor ae target
			  SP0A19_write_cmos_sensor(0xf8,SP0A19_P0_0xf8+0x18);
			  SP0A19_write_cmos_sensor(0xec,SP0A19_P0_0xec+0x18); //indoor ae low bound
			  
			  SP0A19_write_cmos_sensor(0xef,SP0A19_P0_0xef+0x18); //out door
			  SP0A19_write_cmos_sensor(0xf9,SP0A19_P0_0xf9+0x18); 
			  SP0A19_write_cmos_sensor(0xfa,SP0A19_P0_0xfa+0x18); 
			  SP0A19_write_cmos_sensor(0xee,SP0A19_P0_0xee+0x18);
			break;
		...
		case AE_EV_COMP_n13:
			//ae target
			  SP0A19_write_cmos_sensor(0xfd,0x00); 
			  SP0A19_write_cmos_sensor(0xed,SP0A19_P0_0xed-0x18); 
			  SP0A19_write_cmos_sensor(0xf7,SP0A19_P0_0xf7-0x18); 
			  SP0A19_write_cmos_sensor(0xf8,SP0A19_P0_0xf8-0x18); 
			  SP0A19_write_cmos_sensor(0xec,SP0A19_P0_0xec-0x18); 
			  
			  SP0A19_write_cmos_sensor(0xef,SP0A19_P0_0xef-0x18); 
			  SP0A19_write_cmos_sensor(0xf9,SP0A19_P0_0xf9-0x18); 
			  SP0A19_write_cmos_sensor(0xfa,SP0A19_P0_0xfa-0x18); 
			  SP0A19_write_cmos_sensor(0xee,SP0A19_P0_0xee-0x18); 
			break;
...
void SP0A19_set_contrast(UINT16 para)
{
	...
	switch (para)
	{
		...
		case ISP_CONTRAST_LOW:
			SP0A19_write_cmos_sensor(0xdd,SP0A19_P0_0xdd-0x10); 
			SP0A19_write_cmos_sensor(0xde,SP0A19_P0_0xde-0x20); 
			 break;
    ...
    switch (para)
    {
        ...
        case ISP_BRIGHT_HIGH:
			SP0A19_CurrentStatus.iBrightness = ISP_BRIGHT_HIGH;
			 SP0A19_write_cmos_sensor(0xdc,0x00+0x20); //0x10
             break;
        case ISP_BRIGHT_MIDDLE:
        default:
			SP0A19_CurrentStatus.iBrightness = ISP_BRIGHT_MIDDLE;
			SP0A19_write_cmos_sensor(0xdc,0x10); //0x00
             break;
    }
