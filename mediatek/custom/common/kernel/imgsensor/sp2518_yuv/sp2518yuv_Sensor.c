...
//auto lum
#define SP2518_NORMAL_Y0ffset  0x20
#define SP2518_LOWLIGHT_Y0ffset  0x28//0x20

#define SP2518_MAX_GAIN_NOR   0xc4//a8
#define SP2518_MAX_GAIN_LOW  0xc8

//AE target
#define  SP2518_P0_0xf7  0x7c//7c //0x78  //df 84
#define  SP2518_P0_0xf8  0x70//70 //0x6c //df 78
#define  SP2518_P0_0xf9  0x78//78 //df 80
#define  SP2518_P0_0xfa  0x7c//6c //df 74
...
void SP2518_night_mode(kal_bool bEnable)
{
	...
	//capture preview daylight 48M 50hz fix 9FPS maxgain   
		  ...
		  SP2518_write_cmos_sensor(0x9b,0x00);
		  SP2518_write_cmos_sensor(0xfd,0x01);
		  SP2518_write_cmos_sensor(0xce,0x50);
		  SP2518_write_cmos_sensor(0xcf,0x07);
		  SP2518_write_cmos_sensor(0xd0,0x50);
		  SP2518_write_cmos_sensor(0xd1,0x07);
		  SP2518_write_cmos_sensor(0xd7,0x71);//exp_nr_outd_8lsb
		  SP2518_write_cmos_sensor(0xd8,0x00);
		  SP2518_write_cmos_sensor(0xd9,0x75);//exp_outd_nr_8lsb
		  SP2518_write_cmos_sensor(0xda,0x00);
		  SP2518_write_cmos_sensor(0xfd,0x00);
...
//capture preview daylight 48M 60Hz fix 9FPS maxgain   
		 ...
		 SP2518_write_cmos_sensor(0x9b,0x00);
		 SP2518_write_cmos_sensor(0xfd,0x01);
		 SP2518_write_cmos_sensor(0xce,0xa8);
		 SP2518_write_cmos_sensor(0xcf,0x07);
		 SP2518_write_cmos_sensor(0xd0,0xa8);
		 SP2518_write_cmos_sensor(0xd1,0x07);
		 SP2518_write_cmos_sensor(0xd7,0x5e);//exp_nr_outd_8lsb
		 SP2518_write_cmos_sensor(0xd8,0x00);
		 SP2518_write_cmos_sensor(0xd9,0x62);//exp_outd_nr_8lsb
		 SP2518_write_cmos_sensor(0xda,0x00);
		 SP2518_write_cmos_sensor(0xfd,0x00);
...
//Status
 ...
 SP2518_write_cmos_sensor(0xfd , 0x00);
	...
	//raw filter
	SP2518_write_cmos_sensor(0xfd,0x01);
	SP2518_write_cmos_sensor(0xde,0x03);
	SP2518_write_cmos_sensor(0xfd,0x00);
	...
	//Gr、Gb通道间平滑
		...
		SP2518_write_cmos_sensor(0xb7,0xb5);//60raw_gflt_fac_normal  //df b0
	...
	SP2518_write_cmos_sensor(0xc1,0xf0);
		...
		SP2518_write_cmos_sensor(0xd4,0x80);
	SP2518_write_cmos_sensor(0xd6,0x6c);
	SP2518_write_cmos_sensor(0xd7,0x6c);
	SP2518_write_cmos_sensor(0xd8,0x80);
	SP2518_write_cmos_sensor(0xd9,0x80);
	SP2518_write_cmos_sensor(0xda,0x6c);
	SP2518_write_cmos_sensor(0xdb,0x6c);
	//uv_dif
	SP2518_write_cmos_sensor(0xfd,0x00);
...
//gamma2                   
	...
	//HEQ
	SP2518_write_cmos_sensor(0xfd,0x00);//
	SP2518_write_cmos_sensor(0xdd,0x85);//0x80  //df 80 70
	SP2518_write_cmos_sensor(0xde,0xc8);//a0  //df  c0
	...
	SP2518_write_cmos_sensor(0xe8,0x46); //df 3c
	SP2518_write_cmos_sensor(0xec,0x48); //df 40
	SP2518_write_cmos_sensor(0xe9,0x48); //df 2c  3c
	SP2518_write_cmos_sensor(0xed,0x4a); //df 30  40
	...
	SP2518_write_cmos_sensor(0xfd,0x00);
	#ifdef PROJECT_CUSTOMER_J221
	SP2518_write_cmos_sensor(0x31,0x70);//zheng modify form 0x10
	#else
