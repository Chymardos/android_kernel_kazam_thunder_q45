...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.vertical_sync_active				= 4;//0x05 3    2
		params->dsi.vertical_backporch					= 7;//14 20   1
		params->dsi.vertical_frontporch					= 14; //12 1  12
		params->dsi.vertical_active_line				= FRAME_HEIGHT; 

		params->dsi.horizontal_sync_active				= 30;//0x16 50  2
		params->dsi.horizontal_backporch				= 50;//0x38
		params->dsi.horizontal_frontporch				= 50;//0x18
