...
static LCM_setting_table_V3 lcm_initialization_setting[] = {
	...
	{0x15,0x00, 1 , {0xC0}},
	{0x39,0xCF, 11 ,{0x1F,0x01,0x20,0x20,0x00,0x00,0x01,0x81,0x00,0x03,0x08}},
	...
	{0x15,0x00, 1 , {0x00}},
	{0x39,0xE1, 16 ,{0x00,0x0C,0x13,0x0E,0x07,0x0D,0x0A,0x08,0x05,0x09,0x0F,0x08,0x0F,0x11,0x0E,0x06}},

	{0x15,0x00, 1 , {0x00}},
	{0x39,0xE2, 16 ,{0x00,0x0D,0x13,0x0E,0x07,0x0D,0x0A,0x09,0x06,0x09,0x0F,0x08,0x0F,0x11,0x0E,0x06}},
	...
	{REGFLAG_ESCAPE_ID,REGFLAG_DELAY_MS_V3, 10, {}},
        {0x05, 0x22,0,{}},
        {REGFLAG_ESCAPE_ID,REGFLAG_DELAY_MS_V3, 300, {}},
        {0x05, 0x13,0,{}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.horizontal_backporch				= 30; //37
		params->dsi.horizontal_frontporch				= 30; //37
...
static unsigned int lcm_esd_recover(void)
{
	...
	#ifndef BUILD_LK
	printk("lcm_esd_recover  otm1283a_dsi_vdo_hlt_hd \n");
	#endif
	return TRUE;
}

static unsigned int suspend_power(void)
{
	dsi_set_cmdq_V3(lcm_deep_sleep_mode_in_setting, sizeof(lcm_deep_sleep_mode_in_setting)/sizeof(lcm_deep_sleep_mode_in_setting[0]), 1);	
	SET_RESET_PIN(0);
...
LCM_DRIVER otm1283a_dsi_vdo_hlt_hd_lcm_drv = 
{
    .name			= "otm1283a_dsi_vdo_hlt_hd",
...
//	.esd_recover = lcm_esd_recover,
 //       .suspend_power = suspend_power,  //need disable the function
#if (LCM_DSI_CMD_MODE)
    .update         = lcm_update,
#endif
};
