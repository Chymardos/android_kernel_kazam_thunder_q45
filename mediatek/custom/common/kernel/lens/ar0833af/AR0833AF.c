...
static struct i2c_board_info __initdata kd_lens_dev={ I2C_BOARD_INFO("AR0833AF", 0x18)};
...
//extern int mt_set_gpio_mode(u32 u4Pin, u32 u4Mode);
//extern int mt_set_gpio_out(u32 u4Pin, u32 u4PinOut);
//extern int mt_set_gpio_dir(u32 u4Pin, u32 u4Dir);
