...
#if (defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6577) || defined(MT6575) || defined(MT6582))
...
void stk3x1x_eint_func(void)
{
	...
	mt_eint_mask(CUST_EINT_ALS_NUM);    //add by hxh 2013.11.18
...
static void stk3x1x_eint_work(struct work_struct *work)
{
	...
	APS_LOG(" stk3x1x_eint_work  started \n");
...
#endif	
#ifdef MT6582	
	mt_eint_unmask(CUST_EINT_ALS_NUM);    //for test by hxh
#endif
   APS_LOG("stk3x1x_eint_work  finished  \n");
	return;
