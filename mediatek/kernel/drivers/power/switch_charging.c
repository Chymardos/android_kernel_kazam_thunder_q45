...
#ifndef  RECHARGE_TEM_RANGE_MAX
#define  RECHARGE_TEM_RANGE_MAX 5 /*pengjinlong add for recharging depend on battery temperature */
#endif

#ifndef  RECHARGE_TEM_RANGE_MIN
#define  RECHARGE_TEM_RANGE_MIN 1 /*pengjinlong add for recharging depend on battery temperature */
#endif
...
//zhoulidong add 
void rgk_switch_pchr_turn_on_charging (void)
{
...
/*zhoulidong  add for recharging depend on battery temperature start*/
    if( (BMT_status.temperature <= (MAX_CHARGE_TEMPERATURE - RECHARGE_TEM_RANGE_MAX)) &&
	(BMT_status.temperature >= (MIN_CHARGE_TEMPERATURE + RECHARGE_TEM_RANGE_MIN)) &&
...
/*zhoulidong  add for recharging depend on battery temperature end*/
