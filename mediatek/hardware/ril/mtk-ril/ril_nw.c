...
////        upadteSystemPropertyByCurrentMode(rid, PROPERTY_GSM_BASEBAND_CAPABILITY, PROPERTY_GSM_BASEBAND_CAPABILITY2, bearer);
        ...
        upadteSystemPropertyByCurrentModeGemini(rid, PROPERTY_GSM_BASEBAND_CAPABILITY,PROPERTY_GSM_BASEBAND_CAPABILITY2, "gsm.baseband.capability3", "gsm.baseband.capability4", bearer);		
    }
