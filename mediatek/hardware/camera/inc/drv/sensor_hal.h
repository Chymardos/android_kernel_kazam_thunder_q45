...
/**
* @file Sensor_hal.h
* @This file is user space camera sensor driver provided interface definition
*
*/
...
*@Sensor operation scenario enum 
*/
typedef enum
{
...
*@paremeter structure used in sensor hal provided setConf() api to control sensor setting
*/
...
*@paremeter structure used in sensor hal provided sendCommand() api with ID SENSOR_CMD_GET_RAW_INFO to get information from sensor
*/
...
*@paremeter structure used in sensor hal provided sendCommand() api with ID SENSOR_CMD_GET_SENSOR_CROPINFO to get information from sensor
*/
typedef struct {
...
*@paremeter structure used in sensor hal provided sendCommand() api with ID SENSOR_CMD_GET_SENSOR_GRAB_INFO to get information from sensor
*/
typedef struct
{
...
/**
*@enum<halSensorCmd_e>
*@Sensor hal provide sendCommand() defined command id enum definition
*/
typedef enum halSensorCmd_s {
    ...
    SENSOR_CMD_SET_N3D_CONFIG,
    SENSOR_CMD_SET_N3D_I2C_POS,
    SENSOR_CMD_SET_N3D_I2C_TRIGGER,
    SENSOR_CMD_SET_N3D_I2C_STREAM_REGDATA,
    SENSOR_CMD_SET_N3D_START_STREAMING,
    SENSOR_CMD_SET_N3D_STOP_STREAMING,
    ...
    SENSOR_CMD_GET_SENSOR_N3D_DIFFERENCE_COUNT,
    SENSOR_CMD_GET_SENSOR_N3D_STREAM_TO_VSYNC_TIME,
...
*@Sensor output data format type
*/
...
*@Sensor operation valid required delay frame
*/
...
*@Waiting event type for sensor operation
*/
