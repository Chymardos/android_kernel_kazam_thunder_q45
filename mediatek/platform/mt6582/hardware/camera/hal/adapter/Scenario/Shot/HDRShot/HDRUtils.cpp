...
updateInfo()
{
	...
	//
	MY_DBG("[updateInfo] - mi4PictureWidth=%d", mShotParam.mi4PictureWidth);
	MY_DBG("[updateInfo] - mi4PictureHeight=%d", mShotParam.mi4PictureHeight);
	if(mShotParam.mi4PictureWidth<=3200 || mShotParam.mi4PictureHeight<=2400) {
		mHdrRoundTotal = 1;
	} else {
		mHdrRoundTotal = 2;
	}
