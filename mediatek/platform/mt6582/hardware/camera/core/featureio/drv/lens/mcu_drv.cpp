...
)
{
    ...
    if (a_u4CurrSensorDev == SENSOR_DEV_MAIN || a_u4CurrSensorDev == SENSOR_DEV_SUB)   // only search for main sensor, dummy for sub sensor always -> need modify for support 3D
    {
