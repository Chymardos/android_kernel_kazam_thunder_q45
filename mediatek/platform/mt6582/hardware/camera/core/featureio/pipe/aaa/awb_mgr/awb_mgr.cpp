...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MRESULT AwbMgr::cameraPreviewReinit()
{
    MRESULT err;
...
MRESULT AwbMgr::doPvAWB(MINT32 i4FrameCount, MBOOL bAEStable, MINT32 i4SceneLV, MVOID *pAWBStatBuf)
{
    ...
    if ((m_pIsAWBActive[i4FrameCount % m_i4AWBCycleNum]) && m_bEnableAWB)
    {
        ...
        else if ((!m_bAWBLock) || // m_bAWBLock = FALSE
                 ((m_bAWBLock) && (m_bOneShotAWB))) // m_bAWBLock = TRUE and m_bOneShotAWB = TRUE
        {
