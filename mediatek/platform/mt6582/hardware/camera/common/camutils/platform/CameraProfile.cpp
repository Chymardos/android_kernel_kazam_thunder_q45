...
static CPT_Event_Info gCPTEventInfo[Event_Max_Num] =
				{
    				...
    				,{Event_CameraService, Event_Camera, "CameraService"}
						...
						,{Event_CS_setPreviewTexture, Event_CameraService, "setPreviewTexture"}
						...
						,{Event_CS_dataCallback, Event_CameraService, "dataCallback"}
						,{Event_CS_handleCompressedPicture, Event_CameraService, "handleCompressedPicture"}
