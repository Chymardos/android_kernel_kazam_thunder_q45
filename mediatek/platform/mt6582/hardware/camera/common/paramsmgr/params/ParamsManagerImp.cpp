...
//
    ...
    #include <feature/custom/hal/inc/camera_custom_nvram.h>
    #include <feature/custom/hal/inc/debug_exif/aaa/dbg_aaa_param.h>
    #include <feature/custom/hal/inc/debug_exif/aaa/dbg_flash_param.h>
    #include <flash_mgr.h>
#endif
//
...
#undef FALSE
    ...
    if (FlashMgr::getInstance())
    {
        ...
        FlashMgr::getInstance()->egSetMfDutyStep(MtkCameraParameters::KEY_ENG_FLASH_DUTY_DEFAULT_VALUE, MtkCameraParameters::KEY_ENG_FLASH_STEP_DEFAULT_VALUE); // Default values for flash
    }
