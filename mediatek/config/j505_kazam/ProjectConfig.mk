...
CUSTOM_BUILD_VERNO=SW13_KAZAM_Thunder_Q4.5_2014_04_25
# add for internal verno customization by jinhaijian
CUSTOM_INTERNAL_BUILD_VERNO=J505_KAZAM_E1A_V1.4.1_S0425
...
CUSTOM_HAL_IMGSENSOR=ov8825_mipi_raw gc2035_yuv
...
CUSTOM_KERNEL_IMGSENSOR=ov8825_mipi_raw gc2035_yuv
...
CUSTOM_KERNEL_TOUCHPANEL=ili2839d_driver GT9XX_2
...
CUSTOM_LK_LCM=ili9806c_dsi_vdo_by_fwvga_oncell ili9806c_dsi_vdo_djn_fwvga_oncell hx8379a_dsi_vdo_by_fwvga ili9806c_dsi_vdo_azet_fwvga_oncell ili9806e_dsi_vdo_djn_fwvga
...
#modify JWLW-678 liubin 2013.10.12  start
#DEFAULT_INPUT_METHOD=com.sohu.inputmethod.sogou.SogouIME
#DEFAULT_INPUT_METHOD=com.android.inputmethod.latin.LatinIME
#modify JWLW-678 liubin 2013.10.12  end
# add BUG_ID: JWLW-1215  huangyouzhong 20131031 (start)
DEFAULT_INPUT_METHOD=com.google.android.inputmethod.latin/com.android.inputmethod.latin.LatinIME
# add BUG_ID: JWLW-1215  huangyouzhong 20131031 (end)

# Add these variables to define the default input method and default input method languages.
DEFAULT_LATIN_IME_LANGUAGES=en_GB fr ru
...
# modify by huangkunming 20140418 remove mass_storage as default
MTK_MASS_STORAGE=no
...
MTK_RELEASE_PACKAGE=rel_customer_basic rel_customer_platform rel_customer_operator_cmcc rel_customer_operator_cu
...
# M:bug_id:none huangkunming 20140402 modify for open the sdcard shared feature
...
MTK_VLW_APP=yes
#modify BUG_ID:JWLW-1413 daizhiyi 20131014 (start)
MTK_VOICE_UI_SUPPORT=no
#modify BUG_ID:JWLW-1413 daizhiyi 20131014 (end)
...
RESOURCE_OVERLAY_SUPPORT=generic navbar FWVGA
...
CUSTOM_MODEM=sky77590_gsm4_w1258_hspa_gemini
...
BOOT_LOGO=j505_kazam

# To choose kernel LCM driver name
CUSTOM_KERNEL_LCM=ili9806c_dsi_vdo_by_fwvga_oncell ili9806c_dsi_vdo_djn_fwvga_oncell hx8379a_dsi_vdo_by_fwvga ili9806c_dsi_vdo_azet_fwvga_oncell ili9806e_dsi_vdo_djn_fwvga

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=ili9806c_dsi_vdo_by_fwvga_oncell ili9806c_dsi_vdo_djn_fwvga_oncell hx8379a_dsi_vdo_by_fwvga ili9806c_dsi_vdo_azet_fwvga_oncell ili9806e_dsi_vdo_djn_fwvga
...
MTK_PRODUCT_LOCALES=en_GB en_US pl_PL de_DE da_DK fi_FI nb_NO sv_SE es_ES pt_PT lv_LV lt_LT fr_FR it_IT nl_NL el_GR tr_TR bg_BG sr_RS hu_HU hr_HR ro_RO sl_SI cs_CZ sk_SK
...
MTK_BUILD_VERNO = ALPS.JB5.MP.V1.6

#add BUG_ID:DELQ-183 zengchuiguo 20130830 (start)
RGK_INTERNAL_SD_VOLUME_NAME = Thunder_Q45
#add BUG_ID:DELQ-183 zengchuiguo 20130830 (end)

# add feature install on multi storage by jinhaijian
RGK_FEATURE_INSTALL_MULTI_STORAGE=no

#Delete the IP_CALL JWLW-1227 maoxinwei 20131105 start
RGK_IP_DIAL = yes
#Delete the IP_CALL JWLW-1227 maoxinwei 20131105 end

#add BUG_ID:JWLW-682 zhanwenyu 20131010 start
RGK_DEFAULT_MOBILE_DATA_ENABLED = yes
RGK_ALWAYS_SHOW_DATA_TYPE_SUPPORT = no
#add BUG_ID:JWLW-682 zhanwenyu 20131010 end

#add KAZAM Project Support xianglong 20131014 (start)
KAZAM_PROJECT_SUPPORT = yes
...
RGK_VIDEOPLAYER_APP_SUPPORT =no
#add BUG_ID:DLLW-1079 zhushengui 20131018 (end)
#add BUG_ID:JWLW-792 liangyulong 20131025 (start)
RGK_OTA_DELETE_SETTINGS_ABOUT_SYSTEMUPDATES=yes
#add BUG_ID:JWLW-792 liangyulong 20131025 (end)
#add JWLW-900 songqingming 20131025 (start)
RGK_DIALPAD_ASSOCIATE_NUMBER_DIALOG_SUPPORT = yes
#add JWLW-900 songqingming 20131025 (end)

#add BUG_ID:JWLW-1205 daizhiyi 20131031 (start)
RGK_USB_DRIVER_DISPLAY_MANUFACTURER = KAZAM
RGK_USB_DRIVER_DISPLAY_PRODUCT = Thunder_Q45
#add BUG_ID:JWLW-1205 daizhiyi 20131031 (end)
#add JWLW-1235 guochenlong 20131106 (start)
RGK_FEATURE_NATIONAL_ROAMING = yes
#add JWLW-1235 guochenlong 20131106 (end)

#add BUG_ID:JWLW-1236 chenweihua 20131108 (start)
RGK_SHOW_DATA_ENABLE_FIRST_INSERT_SIM_SUPPORT = yes
#add BUG_ID:JWLW-1236 chenweihua 20131108 (end)

#add by zhanwenyu 20131111 (start)
RGK_BLUETOOTH_DISCOVERY_TIME = yes
#add by zhanwenyu 20131111(end)

#add JWLW-999 guochenlong 20131112 (start)
RGK_FEATURE_ROAMING_ON = yes
#add JWLW-999 guochenlong 20131112 (end)
#add BUG_ID:JWLW-892 chenweihua 20131112 (start)
RGK_ENABLE_NETWORK_SETTINGS_UNDER_CALL_SUPPORT = yes
#add BUG_ID:JWLW-892 chenweihua 20131112 (end)
#add BUG_ID:JWLW-1237 chenweihua 20131113 (start)
RGK_SHOW_SIM_CHANGE_DIALOG_WHEN_GMS_RUNNING_SUPPORT = yes
#add BUG_ID:JWLW-1237 chenweihua 20131113 (end)
#add BUG_ID:JWLW-1228 chenweihua 20131118 (start)
RGK_LANGUAGE_SET_BY_SIM_SUPPORT = yes
#add BUG_ID:JWLW-1228 chenweihua 20131118 (end)

#add for TP upgrade support choose 20131114 by xiaoanxiang(start)
RGK_TP_AUTO_UPGRADE_SUPPORT = yes
#add  (end)
#add for TP upgrade  node self apk support 20131114 by xiaoanxiang(start)
RGK_TP_NODE_UPGRAER_SELF_APK_SUPPORT = yes
#add  (end)
